import { ref, openBlock, createElementBlock, reactive, resolveComponent, Fragment, createVNode, createElementVNode, toDisplayString, normalizeClass, createCommentVNode, createApp } from 'vue';
...
var css_248z$4 = ".green {\n\tcolor: green;\n\tfont-size: 16px;\n}\n.url {\n\tbackground: url('./cx.jpeg');\n}";
styleInject(css_248z$4);

var css_248z$3 = ".style-module_foo__1yyfq {\n\tcolor: lightcoral;\n}";
var styleModule = {"foo":"style-module_foo__1yyfq"};
...
const _hoisted_1 = /*#__PURE__*/createElementVNode("h1", null, "helo worldddd!", -1 /* HOISTED */);
const _hoisted_2 = { class: "green" };
const _hoisted_3 = /*#__PURE__*/createElementVNode("input", { type: "range" }, null, -1 /* HOISTED */);
const _hoisted_4 = { class: "red" };
const _hoisted_5 = /*#__PURE__*/createElementVNode("div", { class: "url" }, "css url", -1 /* HOISTED */);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock(Fragment, null, [
    ...
    createElementVNode("div", _hoisted_2, toDisplayString($setup.name), 1 /* TEXT */),
    ...
    _hoisted_3,
    createElementVNode("div", _hoisted_4, toDisplayString($setup.count), 1 /* TEXT */),
    createElementVNode("button", {
      onClick: _cache[0] || (_cache[0] = (...args) => ($setup.handleClick && $setup.handleClick(...args)))
    }, "Click"),
    _hoisted_5,
    createCommentVNode(" <div><img src=\"./cx.jpeg\" alt=\"\"></div> ")
  ], 64 /* STABLE_FRAGMENT */))
}
